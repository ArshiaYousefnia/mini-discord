...
class ChannelRemoveMemberTests(APITestCase):
    def setUp(self):
        ...
        self.remove_url = reverse('channel-remove-member', kwargs={
            'conversation_id': self.conversation.id,
            'user_id': self.target_user.id
        })
        self.self_kick_url = reverse('channel-remove-member', kwargs={
            'conversation_id': self.conversation.id,
    ...
    def test_owner_cannot_kick_themselves(self):
        ...
        response = self.client.delete(self.self_kick_url)
